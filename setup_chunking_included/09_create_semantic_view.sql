...
CALL SYSTEM$CREATE_SEMANTIC_VIEW_FROM_YAML('PRODUCT_AGENT.DATA',
...
verified_queries:
  - name: vqr_0
    ...
    sql: |
      ...
      FROM PRODUCT_AGENT.DATA.PRODUCT_CATALOG
...
-- Verify deployment
SHOW SEMANTIC VIEWS IN PRODUCT_AGENT.DATA;
DESC SEMANTIC VIEW PRODUCT_AGENT.DATA.MCC_PRODUCT_CATALOG;
